# Somaia's Portfolio — Assignment 4

This is the final version of my portfolio website, built on top of Assignment 3.
The goal was to bring everything together into a polished, professional project
that demonstrates my full range of skills. Still plain HTML, CSS, and JavaScript. No frameworks ✨

🌐 **Live Demo:** https://somaiakha.github.io/202257000-SomaiaKhawaji-assignment4/
...
- **Form validation** → name, email, message checked before submit
...
## Project Structure
202257000-SomaiaKhawaji-assignment4/
├── index.html
├── css/
│   └── styles.css
├── js/
...
```bash
git clone https://github.com/Somaiakha/202257000-SomaiaKhawaji-assignment4.git
```
...
- [x] Complete personal web application
